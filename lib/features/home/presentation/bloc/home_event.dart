...
class HomeEvent with _$HomeEvent {
  ...
  const factory HomeEvent.updateOrderStatus(String orderId, String status) = _UpdateOrderStatus;
  const factory HomeEvent.rejectOrder({required String orderId, required String reason}) =
      _RejectOrder;
  const factory HomeEvent.getOrderStats() = _GetOrderStats;
  const factory HomeEvent.initDevice(String deviceId, String deviceToken, String deviceName) =
      _InitDevice;
  ...
  const factory HomeEvent.updateBranchOrderingStatus(String branchId, String status) =
